...
-- [[ 5. HAVA DURUMUNU VE EFEKTLERİ SIFIRLA (YENİ) ]] --
local function cleanLighting()
    Lighting.GlobalShadows = false
    Lighting.FogEnd = 9e9 -- Sisi yok et
    Lighting.Brightness = 1
    Lighting.ClockTime = 12 -- Öğle vakti (Klasik aydınlık)
    Lighting.OutdoorAmbient = Color3.fromRGB(128, 128, 128)
    
    -- Tüm efektleri (Bloom, Blur, SunRays, ColorCorrection) sil
    ...
    -- Klasik düz bir gökyüzü oluştur
...
if eggModel then
    nukeWorld()
    cleanLighting() -- Hava durumunu burada temizliyoruz
    ...
    _G.AutoHatch = true
    print("🚀 Sistem Aktif: " .. targetEggName .. " açılıyor (Hava temizlendi!)")
