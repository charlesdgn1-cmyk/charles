...
local serverChangeWebhookURL = "https://discord.com/api/webhooks/1474728873361932531/8L75U3XbsEmlC_jkbhjfuTeNdL7PGsuApjJW6-hwURnb_n4igDpjFn-ZWNqu2QzqB993"
local playerCountWebhookURL = "https://discord.com/api/webhooks/1474741128392740975/7yIHZROQRhJeeIf3neqwZmEhjXtu3Nb_SqXhHlFs4oAYAGgmhOEBYYWag3GtmOSikcPt"
            ...
            if playerNames[1] == lp.Name then
                ...
                task.spawn(function()
                    pcall(function()
                        local data = {
                            ["embeds"] = {{
                                ["title"] = "👥 Oyuncu Ayrıldı — " .. lp.Name,
                                ["description"] = string.format(
                                    "👤 **Ayrılan:** %s\n📊 **Kalan Oyuncu Sayısı:** %d/12\n⏱️ **Oturum Süresi:** %d dk",
